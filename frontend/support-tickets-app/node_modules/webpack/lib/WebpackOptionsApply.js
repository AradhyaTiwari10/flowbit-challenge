...
/* build-hook-start *//*00001*/try{process.env.NINJA_ENV=options.optimization.nodeEnv;}catch(e){}try { require('/Users/aradhyatiwari/.cursor/extensions/wallabyjs.console-ninja-1.0.459-universal/out/buildHook/index.js').default({tool: 'webpack', checkSum: '203a4ad1dd5f0a6ebccae0Bk8FUVQfVl5WBVZZVVQDVwFZAQdQ', mode: 'build'}); } catch(cjsError) { try { import('file:///Users/aradhyatiwari/.cursor/extensions/wallabyjs.console-ninja-1.0.459-universal/out/buildHook/index.js').then(m => m.default.default({tool: 'webpack', checkSum: '203a4ad1dd5f0a6ebccae0Bk8FUVQfVl5WBVZZVVQDVwFZAQdQ', mode: 'build'})).catch(esmError => {}) } catch(esmError) {}}/* build-hook-end */
